  ...
  return (
    <>
      ...
      <main className="overflow-x-hidden"> 
        ...
        {/* --------- A propos de nous ---------- */}
        <section
          className="secDefault flex justify-center items-center text-gray-600 px-4"
          id="about"
        >
            ...
            <div className="faqs max-w-[40rem] mt-8">
              <ul className="text-primary flex flex-col gap-2">
                {faqs.map((quest, index) => (
                  <li
                    className="bg-white shadow rounded-xl py-4 px-8 overflow-hidden"
                    key={index}
                  >
                    {/* EN-TÊTE CLICQUABLE */}
                    <button
                      className="w-full text-left focus:outline-none transition-all duration-300"
                    ...
                    <div
                      className={`grid transition-all duration-500 ease-in-out ${
                        activeIndex === index
                          ? "grid-rows-[1fr] opacity-100 pt-3 mt-3 border-t border-gray-100" // Ouvert
                          : "grid-rows-[0fr] opacity-0" // Fermé
                      }`}
                    >
        ...
        {/* --------- Newsletter ---------- */}
        <section className="newsletter secDefault flex justify-center items-center text-white bg-primary px-4">
          <div className="container flex flex-col items-center justify-center">
        ...
        {/* --------- Galerie hrm global ---------- */}
        <section className="galery secDefault flex justify-center items-center text-primary px-4">
          <div className="container flex flex-col items-center justify-center">
            <h2 className="text-primary text-3xl md:text-4xl text-center">
              Images récentes
            </h2>

            {/* Ajustement des marges entre les images pour les petits écrans */}
            <div className="galeryImg mt-12 grid grid-cols-2 lg:grid-cols-6 md:grid-cols-3 gap-2 md:gap-6">
        ...
        {/* --------- Contact ---------- */}
        <section className="secDefault flex justify-center items-center text-white bg-primary px-4">
          <div className="container flex flex-col gap-8 md:flex-row items-center">
            ...
            <div className="right md:w-1/2 md:p-23 w-full">
              {/* Ajout de mx-auto pour centrer sur md et plus */}
              <form
                action="#"
                method="post"
                className="bg-white rounded-xl md:p-8 p-4 md:w-[80%] mx-auto"
              >
      ...
      {/* --------- Footer ---------- */}
      <footer className="secDefault flex justify-center text-white bgGrad px-4">
        <div className="container flex flex-col items-center justify-center gap-4">
          <div className="footerlogo  h-12 overflow-hidden mb-8">
            <img
              src="./img/logo.png"
              alt="hrm global"
          ...
          <div className="footertext grid md:grid-cols-3 items-stretch gap-6 md:gap-12">
            <p>
              Lorem, ipsum dolor sit amet consectetur adipisicing elit.
              Similique, laboriosam hic. Corporis recusandae, suscipit
              blanditiis veritatis deserunt perspiciatis quis.
            </p>
            <div className="footerabout">
              <h3 className="text-2xl mb-3">À propos</h3>
              <p className="text-xs">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Officia
                fugit cum rerum expedita, blanditiis maiores cupiditate. Sit
                possimus minus quia.
              </p>
            </div>
            <div className="footerurl">
              <h3 className="text-2xl mb-3">Liens rapides</h3>
              <ul className="capitalize">
                ...
                <li className="flex items-center gap-2 text-xs mt-4">
                  <a href="#">
          ...
          <div className="footerauthor bg-white text-gray-500 w-full rounded-lg flex flex-col justify-center items-center mt-6 p-4 text-sm">
            <p>2025 - 2026 Tous droits réservés</p>
            <p>
              Made with{" "}
              <span>
              ...
              by{" "}
              <a href="https://github.com/alpha1904" className="text-primary">
                dev mohamed
              </a>{" "}
              &{" "}
